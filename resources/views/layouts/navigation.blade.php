<nav x-data="{ 
            ...
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden space-x-4 lg:space-x-6 sm:-my-px sm:ms-4 sm:flex">
                    ...
                    <x-nav-link :href="route('materials.index')" :active="request()->routeIs('materials.*')">
                        <svg class="w-4 h-4 me-1.5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" /></svg>
                        {{ __('Stok Bahan') }}
                    </x-nav-link>
                    <x-nav-link :href="route('cost-sheets.index')" :active="request()->routeIs('cost-sheets.*') || request()->routeIs('production.*')">
                        <svg class="w-4 h-4 me-1.5 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                        {{ __('Kartu HPP & Produksi') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden border-t border-emerald-900 dark:border-slate-800 bg-emerald-800 dark:bg-slate-900">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('cost-sheets.index')" :active="request()->routeIs('cost-sheets.*') || request()->routeIs('production.*')">
                {{ __('Kartu HPP & Produksi') }}
            </x-responsive-nav-link>
